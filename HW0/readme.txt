...
Create a new pull request containing a file that describes at minimum:
    1. Intended platform for final project (e.g. Android, iOS)
        The intended final platform for our group's final project is iOS. However, throughout the project 
        we mainly intend to use Android emulators for testing of the application as all three of us have Windows machines.
        Eventually we plan to try running the application on iOS. We are not entirely sure as to how this will play out 
        and this plan is therefore subject to change as we go along. 
